...
class Policy2ViewController : UIViewController {
    weak var delegate : buttonChecked1?
...
"""
        ...
        let ranges: [NSRange] = [
            (text as NSString).range(of: "홈잇 개인정보처리방침"),
            (text as NSString).range(of: "01 개인정보 수집 및 이용 현황"),
            (text as NSString).range(of: "02 만 14세 미만 아동의 개인정보 처리"),
            (text as NSString).range(of: "03 개인정보 처리업무의 위탁에 관한 사항"),
            (text as NSString).range(of: "04 개인정보 파기 절차 및 방법"),
            (text as NSString).range(of: "05 정보주체와 법정대리인의 권리 의무 및 행사 방법"),
            (text as NSString).range(of: "06 개인정보의 안전성 확보조치에 관한 사항"),
            (text as NSString).range(of: "07 개인정보를 자동으로 수집하는 장치의 설치 운영 및 거부"),
            (text as NSString).range(of: "08 행태정보 수집 이용 제공 및 거부 등에 관한 사항"),
            (text as NSString).range(of: "09 개인(위치)정보 보호책임자에 관한 사항"),
            (text as NSString).range(of: "10 정보주체의 권익침해에 대한 구제방법"),
            (text as NSString).range(of: "11 개인정보처리방침의 시행 및 변경에 관한 사항"),
...
protocol buttonChecked1 : AnyObject{
    func buttonChecked1()
}
