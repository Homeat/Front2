...
//    let member: Member // 게시글 작성자 정보
    ...
    // 초기화
    init(id: Int, title: String, createdAt: String, updatedAt: String?, content: String, love: Int, view: Int?, commentNumber: Int, setLove: Bool, save: String?, infoPictures: [InfoPicture], infoHashTags: [InfoHashTag]?, infoTalkComments: [InfoTalkComment]?) {
        self.id = id
        self.title = title
